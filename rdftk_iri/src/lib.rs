...
//! This crate provides the `Iri`, `Namespace`, `Name`, and `QName`
...
//! ```
//!
//! Where the following table provides a mapping from the BNF production rules above to types in this package.
//!
...
//! ```
//!
//! It also provides a number of additional methods useful to the IRI as a namespace
