...
impl_has_options!(NTripleReader, ReaderOptions);
...
impl ObjectReader<GraphRef> for NTripleReader {
        ...
        R: Read,
    {
        ...
        let mut parsed =
            NTripleParser::parse(Rule::ntriplesDoc, &buffer).map_err(|e| ERROR.parser(e))?;
...
fn ntriples_doc(input_pair: Pair<'_, Rule>, factory: GraphFactoryRef) -> Result<GraphRef, Error> {
...
fn predicate(input_pair: Pair<'_, Rule>) -> Result<IriRef, Error> {
...
fn iri(input_pair: Pair<'_, Rule>) -> Result<IriRef, Error> {
