...
* This crate provides the core RDF data model; concrete implementations for `Statement`s and `Literal`s, along with a `Resource` type that provides a builder-like experience for models.
*
* # Example
*
* ```rust
