...
This crate provides a data model for creating ontologies using [RDF Schema](https://www.w3.org/TR/rdf-schema/) and [OWL 2 Web Ontology Language (OWL)](https://www.w3.org/TR/owl2-overview/).
